...
def run_glide_finetune(
    ...
    # Training setup
    outputs_dir = "/content/drive/My Drive/glide_finetuning/outputs"
    ...
    while epochs_without_improvement < patience:
        ...
        logs_path = '/content/drive/My Drive/glide_finetuning/logs/log.txt'
